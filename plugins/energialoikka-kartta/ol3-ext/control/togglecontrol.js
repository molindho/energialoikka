...
{	options = options || {};
	...
	{	this.subbar_ = options.bar;
		...
		jQuery(this.subbar_.element).addClass("ol-option-bar");
	}
...
{	return jQuery("button", this.element).prop("disabled");
};
...
{	if (this.getDisable()==b) return;
	jQuery("button", this.element).prop("disabled", b);
...
{	return jQuery(this.element).hasClass("ol-active");
};
...
{	if (this.getActive()==b) return;
	if (b) jQuery(this.element).addClass("ol-active");
	else jQuery(this.element).removeClass("ol-active");
