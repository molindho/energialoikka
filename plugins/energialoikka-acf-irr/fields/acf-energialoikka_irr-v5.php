...
class acf_field_energialoikka_irr extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('Energialoikka-IRR', 'acf-energialoikka_irr');
		...
		*  var message = acf._e('energialoikka_irr', 'error');
		*/

		$this->l10n = array(
			'error'	=> __('Error! Please enter a higher value', 'acf-energialoikka_irr'),
		);
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Font Size','acf-energialoikka_irr'),
			'instructions'	=> __('Customise the input font size','acf-energialoikka_irr'),
			'type'			=> 'number',
			'name'			=> 'font_size',
			'prepend'		=> 'px',
		));
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-energialoikka_irr'),
		}
