...
class acf_field_energialoikka_openlayers extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('FIELD_LABEL', 'acf-energialoikka_openlayers');
		...
		*  var message = acf._e('energialoikka_openlayers', 'error');
		*/
		
		$this->l10n = array(
			'error'	=> __('Error! Please enter a higher value', 'acf-energialoikka_openlayers'),
		);
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Font Size','acf-energialoikka_openlayers'),
			'instructions'	=> __('Customise the input font size','acf-energialoikka_openlayers'),
			'type'			=> 'number',
			'name'			=> 'font_size',
			'prepend'		=> 'px',
		));
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-energialoikka_openlayers'),
		}
